...
class BookingServiceTest {
    ...
    @Test
    @DisplayName("TC_1.1: Parametri mancanti - checkAvailability")
    ...
    @Test
    @DisplayName("TC_1.2: Parametri non parsabili - checkAvailability")
    ...
    @Test
    @DisplayName("TC_1.3: Disponibilità positiva - checkAvailability")
    ...
    @Test
    @DisplayName("TC_1.4: Disponibilità negativa - checkAvailability")
    ...
    @Test
    @DisplayName("TC_2.1: Parametri mancanti - createBooking")
    ...
    @Test
    @DisplayName("TC_2.2: Parametri non parsabili - createBooking")
    ...
    @Test
    @DisplayName("TC_2.3: Timeslot non disponibile - createBooking")
    ...
    @Test
    @DisplayName("TC_2.4: Creazione riuscita - createBooking")
    ...
    @Test
    @DisplayName("TC_3.1: ID prenotazione mancante - confirmBooking")
    ...
    @Test
    @DisplayName("TC_3.2: ID prenotazione non parsabile - confirmBooking")
    ...
    @Test
    @DisplayName("TC_3.3: Prenotazione non trovata - confirmBooking")
    ...
    @Test
    @DisplayName("TC_3.4: Conferma riuscita - confirmBooking")
    void testConfirmBooking_Success() throws SQLException {
        ...
        assertEquals("CONCLUSA", mockPrenotazione.getStatusPrenotazione());
    }
